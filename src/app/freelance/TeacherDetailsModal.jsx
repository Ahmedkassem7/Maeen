...
import LoadingSpinner from "../_component/shared/LoadingSpinner";
...
const TeacherDetailsModal = ({
  ...
  if (!teacher && !isLoadingDetails && !detailsError) return null;
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 left-4 z-10 bg-white/90 hover:bg-white p-2 rounded-full shadow-lg transition-all duration-200"
          aria-label="إغلاق"
        >
          <svg
        ...
        {isLoadingDetails && (
          <div className="p-8">
            <LoadingSpinner size="lg" message="جاري تحميل تفاصيل المعلم..." />
          </div>
        )}
        ...
        {detailsError && !isLoadingDetails && (
          <div className="p-8 text-center">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-gray-600 font-arabic">{detailsError}</p>
              {onRetry && (
                <button
                  onClick={() => onRetry(teacherId)}
                  className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-arabic transition-colors duration-200"
                >
        ...
        {/* Success State - Teacher Details */}
        {teacher && !isLoadingDetails && !detailsError && (
          <>
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    label: "التقييم",
                    value: `${(teacher.performance?.rating || 0).toFixed(
                      1
                    )} / 5`,
                    bg: "bg-yellow-500",
                  },
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    {[
                      ...
                      },
                      {
                        label: "سعر الجلسة",
                        value: `${
                          teacher.sessionPrice || 0
                        } ${formattedCurrency(teacher.currency)}`,
