      ...
      <div className="p-6 bg-gradient-to-r from-blue-50 to-blue-100 flex flex-col items-center gap-2">
        <div className="relative">
          <img
            ...
            alt={teacher?.fullName || "معلم الحلقة"}
        ...
        <div className="font-bold text-blue-900 text-lg">{teacher?.fullName}</div>
        ...
        <ul className="space-y-2 px-4 py-4">
          {currentStudent && (
            <li className="flex items-center gap-3 bg-blue-50 border border-blue-200 rounded-xl px-3 py-2">
              <div className="relative">
                <img
                  src={currentStudent?.userId?.profilePicture || "/default-profile.jpg"}
                  alt={currentStudent?.userId?.firstName}
          ...
          {students?.map((student) => {
            const isOnline = onlineUsers.includes(student?.userId?._id);
            return (
              <li
              ...
              >
                <div className="relative">
                  <img
                    src={student?.userId?.profilePicture || "/default-profile.jpg"}
