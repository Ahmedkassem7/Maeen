...
export default function ConfirmEmailPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center px-4 sm:px-6 lg:px-8" dir="rtl">
      {/* Background Pattern */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-blue-100 rounded-full opacity-20 blur-3xl floating"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-indigo-100 rounded-full opacity-20 blur-3xl floating" style={{animationDelay: '3s'}}></div>
      </div>
      ...
      <div className="relative w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">تأكيد البريد الإلكتروني</h2>
          <p className="text-gray-600 text-base">تحقق من بريدك الإلكتروني لتفعيل حسابك</p>
        </div>
        ...
        <div className="auth-card rounded-2xl shadow-xl p-8 text-center space-y-6">
          ...
          <div className="space-y-3">
            <h3 className="text-xl font-semibold text-gray-900">تم إرسال رسالة التأكيد</h3>
            <p className="text-gray-600">
              لقد أرسلنا رسالة تأكيد إلى بريدك الإلكتروني. يرجى فتح الرسالة والنقر على رابط التفعيل لإكمال تسجيل حسابك.
            </p>
          </div>

          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
            <h4 className="text-sm font-semibold text-blue-800 mb-2">لم تجد الرسالة؟</h4>
