...
export default function Navbar() {
  ...
  // Initial load and socket setup for students
  useEffect(() => {
    if (!isAuthenticated || !user || user.userType !== "student") return;
    loadNotifications();
    // const socket = initNotificationSocket(user._id, (notification) => {
